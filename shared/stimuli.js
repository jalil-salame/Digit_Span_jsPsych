...
function digitSpanStimuliForTreatment(treatment) {
    return {
        ...
        digit7: {
            level1: createStimuli(["5", "9", "1", "7", "3", "8", "2"], 1, 7, treatment),
            level2: createStimuli(["4", "1", "5", "9", "3", "8", "6"], 2, 7, treatment),
            level3: createStimuli(["6", "5", "1", "4", "3", "9", "2"], 3, 7, treatment),
            level4: createStimuli(["1", "4", "2", "5", "3", "8", "6"], 4, 7, treatment),
        },
        digit8: {
            level1: createStimuli(["5", "8", "1", "9", "2", "6", "4", "3"], 1, 8, treatment),
            level2: createStimuli(["3", "7", "2", "9", "5", "1", "8", "6"], 2, 8, treatment),
            level3: createStimuli(["5", "9", "1", "6", "8", "3", "4", "2"], 3, 8, treatment),
            level4: createStimuli(["3", "2", "5", "7", "6", "9", "1", "8"], 4, 8, treatment),
        },
        digit9: {
            level1: createStimuli(["2", "7", "5", "8", "6", "3", "9", "1", "4"], 1, 9, treatment),
            level2: createStimuli(["7", "1", "3", "9", "4", "2", "5", "6", "8"], 2, 9, treatment),
            level3: createStimuli(["8", "1", "4", "9", "6", "2", "5", "7", "3"], 3, 9, treatment),
            level4: createStimuli(["2", "9", "5", "1", "7", "3", "4", "6", "8"], 4, 9, treatment),
        }
    }
}
